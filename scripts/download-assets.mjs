...
const CDN =
  "https://codebuddy-1328495429.cos.accelerate.myqcloud.com/web/workbuddy/0fadefe472cfb64411edc82a21f5625ea892e899/assets";
...
for (let i = 0; i < entries.length; i += 4) {
  ...
  const results = await Promise.allSettled(
    batch.map(([rel, url]) => download(rel, url)),
  );
